    ...
    <div id="background">
        <div id="mainFrame">
            <section>
                <div class="card">
                    <?php
                        if(isset($_GET["Impressum"]) || !isset($_GET["Datenschutzerklärung"])){
                            include "php/htmlElements/impressum.php";
                        }elseif(isset($_GET["Datenschutzerklärung"])) {
                            include "php/htmlElements/privacyStatment.php";
                        }
                    ?>
                </div>
            </section>
